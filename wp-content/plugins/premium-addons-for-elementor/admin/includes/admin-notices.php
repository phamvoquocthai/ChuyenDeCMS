...
class Admin_Notices {
	 ...
	 * @return void
	 */
	public function get_site_logo_notice() {

		$logo_notice = get_option( 'site_logo_notice' );

		if ( '1' === $logo_notice ) {
			return;
		}

		$notice_url = Helper_Functions::get_campaign_link( 'https://premiumaddons.com/elementor-site-logo-widget/', 'site-logo-notification', 'wp-dash', 'site-logo' );
		...
		<div class="error pa-notice-wrap pa-new-feature-notice">
			...
			<div class="pa-text-wrap">
				<p>
					<strong><?php echo esc_html( __( 'Premium Site Logo Widget', 'premium-addons-for-elemetor' ) ); ?></strong>
			...
			<div class="pa-notice-close" data-notice="logo">
